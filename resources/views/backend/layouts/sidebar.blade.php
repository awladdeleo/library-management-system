            ...
            <ul class="menu-nav">
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('translation.Dashboard') }}</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ Request::is('users*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('users.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('user.Users') }}</span>
                    </a>
                </li>

                <li class="menu-item {{ Request::is('books*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('books.index') }}" class="menu-link">
										<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-03-11-144509/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Box1.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">{{ __('book.Books') }}</span>
                    </a>
                </li>

                <li class="menu-item {{ Request::is('book-circulation*') ? 'menu-item-active menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">{{ __('circulation.BookCirculation') }}</span>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::is('book-circulation/issue') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{route('circulation.issue.book')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ __('circulation.IssueBook') }}</span>
                                </a>
                            </li>

                            <li class="menu-item {{ Request::is('book-circulation/issue') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{route('circulation.return.book')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ __('circulation.ReturnBook') }}</span>
