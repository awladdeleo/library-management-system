        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(array('route' =>'books.store', 'method'=>'post','id'=>'book-form')) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-7 ">
                                 <textarea style="resize: none" name="description" rows="5" id="description"
                                           class="summernote form-control field-validate {{$errors->has('description') ? 'is-invalid' :'' }}">{{old('description')}}</textarea>
