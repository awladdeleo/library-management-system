    ...
    <a href="" data-toggle="tooltip" data-theme="dark"
       title="{{$title}}" delete_url="{{ $name }}"
       delete_id="{{ $id }}" delete_msg="{{ $message }}"
       class="btn btn-icon btn-light {{$class}} btn-sm deleteId">
