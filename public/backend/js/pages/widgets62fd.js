        ...
        init: function () {
            ...
            !function () {
                if (0 != $("#kt_dashboard_daterangepicker").length) {
                    var t = $("#kt_dashboard_daterangepicker"), e = moment(), o = moment();
                    t.daterangepicker({
                    ...
                    var e = {
                        ...
                        xaxis: {
                            ...
                            crosshairs: {
                                show: !1,
                                position: "front",
                                stroke: {color: KTApp.getSettings().colors.gray["gray-300"], width: 1, dashArray: 3}
                            },
                            tooltip: {
                                enabled: !0,
                                formatter: void 0,
                ...
                var t = document.getElementById("kt_stats_widget_10_chart"), e = parseInt(KTUtil.css(t, "height")),
                ...
                var t = document.getElementById("kt_stats_widget_12_chart"), e = parseInt(KTUtil.css(t, "height")),
                ...
                if (t) {
                    var e = {
                        ...
                        xaxis: {
                            ...
                            crosshairs: {
                                position: "front",
                                stroke: {color: KTApp.getSettings().colors.theme.base.info, width: 1, dashArray: 3}
                            },
                            tooltip: {
                                enabled: !0,
                                formatter: void 0,
                ...
                if (t) {
                    var e = {
                        ...
                        xaxis: {
                            ...
                            crosshairs: {
                                position: "front",
                                stroke: {color: KTApp.getSettings().colors.theme.light.success, width: 1, dashArray: 3}
                            },
                            tooltip: {
                                enabled: !0,
                                formatter: void 0,
                ...
                if (t) {
                    var e = {
                        series: [{name: "Net Profit", data: [20, 30, 45, 35, 25]}, {
                            name: "Revenue",
                            data: [-20, -30, -45, -35, -25]
                        }],
                        chart: {type: "bar", stacked: !0, height: 350, toolbar: {show: !1}},
                        plotOptions: {bar: {horizontal: !1, columnWidth: ["17%"], endingShape: "rounded"}},
                        legend: {show: !1},
                        dataLabels: {enabled: !1},
                ...
                var t = document.getElementById("kt_mixed_widget_1_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = "#D13647", s = {
                ...
                var t = document.getElementById("kt_mixed_widget_2_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = "#287ED7", s = {
                        series: [{name: "Net Profit", data: [30, 45, 32, 70, 40, 40, 40]}],
                        chart: {
                ...
                var t = document.getElementById("kt_mixed_widget_3_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = KTApp.getSettings().colors.theme.base.white, s = {
                        series: [{name: "Net Profit", data: [30, 45, 32, 70, 40, 40, 40]}],
                        chart: {
                            type: "area",
                            height: e,
                ...
                var t = document.getElementById("kt_mixed_widget_4_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [{name: "Net Profit", data: [35, 65, 75, 55, 45, 60, 55]}, {
                            name: "Revenue",
                ...
                var t = document.getElementById("kt_mixed_widget_5_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [{name: "Net Profit", data: [35, 65, 75, 55, 45, 60, 55]}, {
                            name: "Revenue",
                ...
                var t = document.getElementById("kt_mixed_widget_6_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [{name: "Net Profit", data: [35, 65, 75, 55, 45, 60, 55]}, {
                            name: "Revenue",
                ...
                var t = document.getElementById("kt_mixed_widget_13_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                ...
                var t = document.getElementById("kt_mixed_widget_14_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [74],
                ...
                var t = document.getElementById("kt_mixed_widget_15_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                ...
                var t = document.getElementById("kt_mixed_widget_16_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [60, 50, 75, 80],
                        chart: {height: e, type: "radialBar"},
                        plotOptions: {
                            radialBar: {
                                ...
                                dataLabels: {
                                    ...
                                    total: {
                                        show: !0, label: "Total", fontWeight: "bold", formatter: function (t) {
                                            return "60%"
                                        }
                                    }
                                },
                ...
                var t = document.getElementById("kt_mixed_widget_18_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [74],
                ...
                var t = document.getElementById("kt_tiles_widget_2_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = KTUtil.changeColor(KTApp.getSettings().colors.theme.base.danger),
                        s = KTUtil.changeColor(KTApp.getSettings().colors.theme.base.danger), a = {
                ...
                var t = document.getElementById("kt_tiles_widget_5_chart"), e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = {
                        series: [{name: "Net Profit", data: [10, 15, 18, 14]}, {
                            name: "Revenue",
                            data: [8, 13, 16, 12]
                        }],
                        chart: {
                        ...
                        dataLabels: {enabled: !1},
                        fill: {type: ["solid", "gradient"], opacity: .25},
                ...
                var t = document.getElementById("kt_tiles_widget_21_chart"), e = parseInt(KTUtil.css(t, "height")),
                    o = KTUtil.hasAttr(t, "data-color") ? KTUtil.attr(t, "data-color") : "info";
                if (t) {
                    var s = {
                ...
                modules: {toolbar: {container: "#kt_forms_widget_2_editor_toolbar"}},
